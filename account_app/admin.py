...
class UserCreationForm(forms.ModelForm):
    ...
    password_confirmation = forms.CharField(label='Password confirmation', min_length=6, widget=forms.PasswordInput)
...
class UserAdmin(BaseUserAdmin):
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'username', 'is_active', 'is_admin', 'password', 'password_confirmation')}
        ),
    )
