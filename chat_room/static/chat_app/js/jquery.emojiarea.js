...
(function ($, window, document) {
    ...
    */
    ...
    var EmojiArea_WYSIWYG = function ($textarea, id, options) {
        ...
        //     if (event.keyCode == "13") {
        //         let send_btn = document.getElementById("chat-message-submit");
        //         send_btn.click();
        //     }
        // });
        ...
        // smiley.setAttribute("class", "write-link smiley emoji-picker" + this.options.popupButtonClasses);
        // smiley.setAttribute("data-id", id);
        // smiley.setAttribute("data-type", "picker");
        $textarea.before("<i class='write-link smiley emoji-picker " + this.options.popupButtonClasses + "' data-id='" + id + "' data-type='picker'></i>");
...
//      scrollHeight -= parseInt(this.css('padding-top')) + parseInt(this.css('padding-bottom'));
    ...
    var EmojiMenu = function (emojiarea) {
        ...
        this.$categoryTabs = $(
            ...
            + '<td><a class="emoji-menu-tab emoji-recent" ></a></td>'
            + '<td><a class="emoji-menu-tab emoji-smile" ></a></td>'
            + '<td><a class="emoji-menu-tab emoji-flower"></a></td>'
            + '<td><a class="emoji-menu-tab emoji-bell"></a></td>'
            + '<td><a class="emoji-menu-tab emoji-car"></a></td>'
            + '<td><a class="emoji-menu-tab emoji-grid"></a></td>'
