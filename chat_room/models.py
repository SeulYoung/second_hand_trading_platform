...
class Communication(models.Model):
    chatter1 = models.OneToOneField('MyUser', to_field='user_id', on_delete=models.CASCADE)
    chatter2 = models.OneToOneField('MyUser', to_field='user_id', on_delete=models.CASCADE)
